...
<?php
    ...
    if(isset($_POST["submit"])){
        $field_required = array("Email","Mobile_no");
    ...
    if($value2 == 2 ){
        if( $value3 == 2 )  {
            $query = "INSERT INTO information_form (name,university,department,country,gender,email_address,mobile_no) VALUES ('$name','$university','$department','$country','$gender','$email','$mobile_no')";
            mysqli_query($connection , $query);
            
            header("location: set_username_&_password_teacher.php");
        }
    }
...
<body>
    <div id="form">
        <form action="" method="post">
            <div id="form_title"><font><b>Please fillup required information.</b> </font>
            </div><br><br>
